        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <p className="text-gray-600 mb-8">
              We're passionate about leveraging AI and automation to solve complex business challenges. 
              Whether you need AI solutions, computer vision, e-commerce platforms, or robotics automation, 
